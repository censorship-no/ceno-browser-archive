...
export PATH="${MOZBUILD_STATE_PATH}/android-sdk-linux/build-tools/27.0.3/:$HOME/.cargo/bin:$PATH"
...
ac_add_options --with-android-ndk="${MOZBUILD_STATE_PATH}/android-ndk-r17b"
